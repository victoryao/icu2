...
import com.xiaomi.xms.sales.ui.XianhuoShoppingListItem;
import com.xiaomi.xms.sales.util.LogUtil;

import java.util.ArrayList;

public class XianhuoShoppingAdapter extends BaseDataAdapter<Item> {
    ...
    private final static String TAG = "XianhuoShoppingAdapter";

    public XianhuoShoppingAdapter(Context context) {
        super(context);
    }
    ...
    public View newView(Context context, Item data, ViewGroup parent) {
        ...
        if (data.getType() == Item.TYPE_CARTLIST) {
        	XianhuoShoppingListItem item = new XianhuoShoppingListItem(context, null);
    ...
    public void bindView(View view, int position, Item data) {
        ...
        if (data.getType() == Item.TYPE_CARTLIST) {
            if (view instanceof XianhuoShoppingListItem) {
                ((XianhuoShoppingListItem) view).bind((CartListNode) data.getNode());
                ((XianhuoShoppingListItem) view).setTag(data);
    ...
    protected void bindBackground(View view, int position) {
        ...
        if (type == Item.TYPE_CARTLIST) {
            bgView = ((XianhuoShoppingListItem) view).getContainer();
